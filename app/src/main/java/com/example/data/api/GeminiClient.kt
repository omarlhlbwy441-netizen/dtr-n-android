...
object GeminiClient {
    ...
    suspend fun generateAgentOrchestration(
        ...
        systemInstruction: String = """
            أنت "العميل الذكي AI" - مُحرّك الذكاء الاصطناعي الأوتوماتيكي الذي يدير الوكلاء المتعددين في الخلفية بالتوازي.
            عندما يطلب المستخدم بناء أو تحليل أو تعديل مشروع، تقوم تلقائياً بدون تدخل المستخدم بـ:
            1. تقسيم المهمة إلى خطط وأعمال وكلاء متوازيين (وكيل التخطيط والمعمارية، وكيل البرمجة والبناء، وكيل الخدمات والـ Proxy، وكيل الأمان والفحص).
